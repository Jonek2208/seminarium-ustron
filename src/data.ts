export class Person {
  ...
  photo?: string;
  show: boolean;
  constructor(name: string, title: string, id: string, photo?: string, show=false) {
    this.name = name;
    this.title = title;
    this.id = id;
    this.photo = photo;
  ...
  imageUrl() {
    return this.photo ? `/avatars/${this.photo}.jpg` : undefined;
  }
}
export type Article = {
  title: string;
...
Wykładowcami byli:
 ...
 - Bogusław Helbin - List Jakuba`
  },
  {
    ...
    authorId: "helbin-boguslaw",
    title: "Zjazd seminaryjny luty 2024",
...
24 lutego 2024 r. miało miejsce uroczyste zakończenie nauki czwórki wspaniałych absolwentów Seminarium Teologicznego w Ustroniu.`,
  },
  {
    ...
    authorId: "helbin-boguslaw",
    title: "Seminarium w Ustroniu ogłasza nabór na lata 2024-2026",
...
- <a href='tel:+48507402067'>507 402 067</a> - Piotr Grzesiek`,
  ...
  },
  {
    ...
    images: ['/photos/40lecie/IMG-20231111-WA0002.jpg',
    '/photos/40lecie/IMG-20231111-WA0008.jpg',
    '/photos/40lecie/IMG-20231111-WA0014.jpg',
    '/photos/40lecie/IMG-20231111-WA0016.jpg',
    '/photos/40lecie/IMG-20231111-WA0020.jpg',
    '/photos/40lecie/IMG-20231111-WA0022.jpg',
    '/photos/40lecie/IMG-20231111-WA0023.jpg',
    '/photos/40lecie/IMG-20231111-WA0024.jpg',
    '/photos/40lecie/IMG-20231111-WA0025.jpg',
    '/photos/40lecie/IMG-20231111-WA0027.jpg',
    '/photos/40lecie/IMG-20231111-WA0037.jpg',
    '/photos/40lecie/IMG-20231111-WA0040.jpg',
    '/photos/40lecie/IMG-20231111-WA0043.jpg',
    '/photos/40lecie/IMG-20231111-WA0045.jpg',
    '/photos/40lecie/IMG-20231111-WA0058.jpg',
    '/photos/40lecie/IMG-20231111-WA0059.jpg',
    '/photos/40lecie/IMG-20231111-WA0060.jpg',
    '/photos/40lecie/IMG-20231112-WA0000.jpg',
    '/photos/40lecie/IMG-20231112-WA0001.jpg',
    '/photos/40lecie/IMG-20231112-WA0002.jpg',
    '/photos/40lecie/IMG-20231112-WA0020.jpg',
    '/photos/40lecie/IMG-20231112-WA0029.jpg']
  },
  {
    articleId: "historia-seminarium",
    authorId: "luber-andrzej",
    title: "Historia Seminarium Teologicznego w Ustroniu",
    tags: ["Czytelnia"],
    date: new Date("2023-10-18"),
    path: "historia_seminarium.md",
    content:
  ...
  {
    articleId: "wieczerza-panska",
    authorId: "helbin-boguslaw",
    title: "Wieczerza Pańska i jej znaczenie",
    tags: ['Czytelnia'],
    date: new Date("2023-08-20"),
    path: "wieczerza_panska.md",
    content:
  ...
  {
    articleId: "blogoslawienstwo-dziecka",
    authorId: "helbin-boguslaw",
    title: "Błogosławieństwo dziecka",
  ...
  // { title: 'Esej o Masoretach', articleId: '0', authorId: 1, date: new Date('2020-01-01'), content: 'Chlubimy się tysiącletnią tradycją chrześcijaństwa w Polsce. To niewiele na tle kilku tysięcy lat dziejów przymierza Boga z człowiekiem. Pan Bóg objawił się Abrahamowi i wybrał go na swego sługę.' },
  // { title: 'Esej o Krzyżu', articleId: '1', authorId: 1, date: new Date('2021-01-01'), content: 'Niedawno byliśmy świadkami walki o krzyż. Cała Polska patrzyła na Krakowskie Przedmieście i zastanawialiśmy się, jak długo to potrwa i kto zostanie opluty w słusznej sprawie. Był nawet pastor, który afiszował swoje poglądy na tle krzyża. Pomyślałem wtedy, że konflikt o krzyż przekroczył wszelkie granice.' },
  // { title: 'Chrzest Nowego Przymierza', articleId: '2', authorId: 0, date: new Date('2022-01-01'), content: 'Jakie jest biblijne znaczenie chrztu wodnego ? Czy jest ważny w życiu Bożego dziecka? Czy sama wiara w Pana Jezusa nie wystarcza? Na te i wiele innych pytań znajdziesz odpowiedź w tym materiale.' },
];